...
public class BuildBedAction : GAction
{
    ...
    public BuildBedAction()
    {
        ...
        AddPrecondition(nameof(StateKeys.LeafInv), 1);

        AddEffect(nameof(StateKeys.OwnsBed), true);
        AddEffect(nameof(StateKeys.LeafInv), 0);
    }
    ...
    {
        Debug.Log("I have started building a bed!");
